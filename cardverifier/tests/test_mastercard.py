...
class MasterCardTestCase(TestCase):
    ...
    def test_control(self):
        ...
        self.assertEqual(response.data['emisor'], 'MasterCard')
    ...
    def test_spaced(self):
        ...
        test_consult_data = {
            "card_number": "5229 6572 6412 5429"
        }
